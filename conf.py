...
project = 'Петља - Области примене савременог рачунарства за 4. разред гимназије'
...
html_context = {'course_id': 'gim4_primene_racunarstva',
                ...
                'basecourse': 'gim4_primene_racunarstva',
...
html_theme_options = {
    ...
    'navbar_title': "Петља - Области примене савременог рачунарства за 4. разред гимназије",
...
html_title = 'Петља - Области примене савременог рачунарства за 4. разред гимназије'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Петља - Области примене савременог рачунарства за 4. разред гимназије'
...
htmlhelp_basename = 'gim4_primene_racunarstva-doc'
